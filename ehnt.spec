...
Summary(pl):	Extreme Happy Netflow Tool
Name:		ehnt
Version:	0.3
Release:	1
License:	GPL
...
Source1:	http://prdownloads.sourceforge.net/%{name}/%{name}_data-%{version}.tar.gz
...
%description -l pl
EHNT to oprogramowanie do wyci±gania przydatnych informacji ze statystyk
generowanych przez routery Cisco/Juniper/Foundry, znanych jako netflow.
